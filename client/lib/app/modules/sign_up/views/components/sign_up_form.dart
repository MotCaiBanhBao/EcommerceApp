...
import 'package:client/app/modules/sign_up/bloc/sign_up_bloc.dart';
...
import '../../../complete_profile/views/complete_profile_screen.dart';
              ...
              DefaultButton(
                ...
                press: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    context
                        .read<SignUpBloc>()
                        .add(SignUpEvent.submit(email!, password!));
                  }
                },
              ),
            ],
