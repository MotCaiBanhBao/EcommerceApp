...
class OrderDetailWrapperScreen extends StatelessWidget {
  final String orderID;
  const OrderDetailWrapperScreen({Key? key, required this.orderID})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      )..add(OrderDetailEvent.started(orderID)),
                        ...
                        Column(
                          children: [
                            ...
                            TextButton(
                                ...
                                child: const Text('Contact with shop')),
                            Builder(builder: (context) {
                              ...
                              } else if (state.order?.status == 'Delivered') {
                                print('cosssss');
                                return Column(
                                  children: [
                                    Row(
